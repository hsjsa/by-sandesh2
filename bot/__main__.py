...
from bot import bot, app, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, IMAGE_URL, alive, AUTHORIZED_CHATS, LOGGER, Interval, rss_session
...
def stats(update, context):
    ...
    stats = f'<b>╭──「 BOT STATISTICS 」</b>\n' \
            ...
            f'<b>│</b>\n' \
            f'<b>╰──「 @Superior_Mirror 」</b>'
    update.effective_message.reply_photo(IMAGE_URL, stats, parse_mode=ParseMode.HTML)


def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Updates Channel", "https://t.me/Superior_Mirror")
...
'''
        ...
        button = ButtonMaker()
        button.buildbutton("Join Mirror Group", f"https://t.me/Superior_Mirror")
        jonchannelbutton = InlineKeyboardMarkup(button.build_menu(1))
        sendMarkup(f'<b>Dear</b> {uname},\n\n<b>If You Want To Use Me, \nJoin My Mirror Group And Use me there</b>\n', context.bot, update.message, jonchannelbutton)
...
help = telegraph.create_page(
        title='Superior-Mirror Bot Help',
