...
class _BotCommands:
    def __init__(self):
        ...
        self.AddSudoCommand = f'sudo{CMD_INDEX}'
        ...
        self.WatchCommand = f'yt{CMD_INDEX}'
        self.ZipWatchCommand = f'ytzip{CMD_INDEX}'
        ...
        self.LeechZipWatchCommand = f'ytzipleech{CMD_INDEX}'
