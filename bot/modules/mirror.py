...
from bot import bot, Interval, LEECH_LOG, MIRROR_LOGS, INDEX_URL, BUTTON_FOUR_NAME, BUTTON_FOUR_URL, BUTTON_FIVE_NAME, BUTTON_FIVE_URL, \
...
class MirrorListener:
    ...
    def onUploadComplete(self, link: str, size, files, folders, typ, name: str):
        msg = f"<b>Filename: </b><code>{escape(name)}</code>\n\n<b>Size: </b>{size}"
            ...
            if LEECH_LOG:
                try:
                    ...
                    if source_link.startswith('magnet:'):
                        ...
                        LOGGER.info(f'Provided Link Is a magnet link so using if condition for sending normal source magnet link along with mirrored log msg in log channel ')
                    else:
                        sourceleechmsg += f'\n<b>Source Url</b>: <b><a href="{sourcelink}">Here</a></b>'
                        LOGGER.info(f'Provided Link Is not a magnet link so using else condition for sending normal source link along with mirrored log msg in log channel ')
                    sourceleechmsg += f"\n━━━━━━━━━━━━━━━━━━━━━━\n"
                    sourceleechmsg += f"ㅤㅤ ㅤ <b>«Leeched Info»</b>\n"
                    msg1 = f'\n{msg}'
                    for i in LEECH_LOG:
                        bot.sendMessage(i, text=sourceleechmsg + msg1 + fmsg,  parse_mode=ParseMode.HTML, disable_web_page_preview=True)
                except IndexError:
                    pass
                if replyto is not None:
                    try:
                        ...
                        if is_url(reply_text):
                           ...
                           msg2 = f'\n{msg} '
                           for i in LEECH_LOG:
                               bot.sendMessage(i, text=sourceleechmsg2 + msg2 + fmsg, parse_mode=ParseMode.HTML, disable_web_page_preview=True)
                    except:
                           for i in LEECH_LOG:
                               sourceleechmsg4 = f"<b>#Leeched</b>\n"
                               sourceleechmsg4 += f"\n━━━━━━━━━━━━━━━━━━━━━━"
                               sourceleechmsg4 += f'\n<b>Source Url:</b> <b>NA: (User Leeched By Telegram File.)</b>'
                               sourceleechmsg4 += f"\n━━━━━━━━━━━━━━━━━━━━━━\n"
                               sourceleechmsg4 += f"ㅤㅤ ㅤ <b>«Leeched Info»</b>\n\n"
                               bot.sendMessage(chat_id=i, text=sourceleechmsg4 + msg + fmsg, parse_mode=ParseMode.HTML, disable_web_page_preview=True)
                               pass
            ...
            if MIRROR_LOGS:
                try:
                    ...
                    for i in MIRROR_LOGS:
                        bot.sendMessage(i, text=sourcemirrormsg + msg1, reply_markup=InlineKeyboardMarkup(buttons.build_menu(2)), parse_mode=ParseMode.HTML, disable_web_page_preview=True)
                except IndexError:
                    pass
                if reply_to is not None:
                    try:
                        ...
                        if is_url(reply_text):
                           ...
                           msg2 += f'\n━━━━━━━━━━━━━━━━━━━━━━'
                           for i in MIRROR_LOGS:
                               bot.sendMessage(chat_id=i, text=sourcemirrormsg2 + msg2, reply_markup=InlineKeyboardMarkup(buttons.build_menu(2)), parse_mode=ParseMode.HTML, disable_web_page_preview=True)
                    except:
                           for i in MIRROR_LOGS:
                               sourcemirrormsg3 = f"<b>#Mirrored</b>\n"
                               sourcemirrormsg3 += f"\n━━━━━━━━━━━━━━━━━━━━━━"
                               sourcemirrormsg3 += f'\n<b>Source Url:</b> <b>NA: (User Mirrored By Telegram File.)</b>'
                               sourcemirrormsg3 += f"\n━━━━━━━━━━━━━━━━━━━━━━\n"
                               sourcemirrormsg3 += f"ㅤㅤ ㅤ  «<b>Mirrored info</b>»\n"
                               msg3 = f'\n{msg} '
                               msg3 += f'\n━━━━━━━━━━━━━━━━━━━━━━'
                               bot.sendMessage(chat_id=i, text=sourcemirrormsg3 + msg3, reply_markup=InlineKeyboardMarkup(buttons.build_menu(2)), parse_mode=ParseMode.HTML, disable_web_page_preview=True)
                               pass
